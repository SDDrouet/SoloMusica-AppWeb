        ...
        <header className='flex items-center w-full p-4 md:py-2 md:px-6 bg-primary text-white'>
            ...
            >
                <img
                    ...
                    className='w-11 h-11 min-w-[40px] object-cover rounded-full shadow-md border-2 border-cyan-500'
                    alt=""
                    referrerPolicy='no-referrer'
                />
                <div className='flex flex-col pr-2'>
                    <p className='text-gray-300 text-lg font-semibold truncate max-w-[150px]'>
                        {user?.user?.name}
                    </p>
                    <p className='flex items-center gap-1 text-xs text-cyan-500 font-medium'>
                ...
                {isMenu && (
                    <motion.div
                        ...
                        className='absolute z-10 top-20 p-4 right-0 w-275 gap-2 bg-primary shadow-lg rounded-lg backdrop-blur-sm flex flex-col'>
                        <NavLink to={'/userProfile'}>
                            <p className='flex items-center gap-1 text-base text-gray-100 hover:font-semibold hover:text-cyan-500 transition duration-300 ease-in-out'><FaUser /> Perfil</p>
                        </NavLink>
