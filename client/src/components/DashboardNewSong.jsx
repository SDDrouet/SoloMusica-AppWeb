...
const DashboardNewSong = () => {
  ...
  return (
    <div className='flex items-start justify-start gap-4 w-full mb-8'>
      {/* new song  Form*/}
      <div className='flex flex-col items-center w-1/2 justify-center px-4 py-7 border border-secondaryColorLight rounded-md bg-secondaryColor gap-4'>
        ...
        <div className='flex items-center justify-center w-1/2 cursor-pointer'>
        ...
        <div className='flex w-full h-1/2 flex-col items-center justify-center px-4 py-8 border border-secondaryColorLight rounded-md bg-secondaryColor gap-4'>
          ...
          <div className='relative flex w-full h-full items-start justify-start gap-4'>
            ...
            <div className='flex flex-col items-center justify-center w-1/2 h-full gap-2'>
              ...
              <div className='absolute bottom-0 w-1/2 right-0 cursor-pointer'>
                {isArtistLoading ? (
                  <DisabledButton />
                ) : (
                  <motion.button
        ...
        <div className='flex w-full h-1/2 flex-col items-center justify-center px-4 py-8 border border-secondaryColorLight rounded-md bg-secondaryColor gap-4'>
          ...
          <div className='relative flex w-full h-full items-start justify-start gap-4'>
            ...
            <div className='flex flex-col items-center justify-start w-1/2 h-52 gap-2'>
              ...
              <div className='absolute w-1/2 bottom-0 right-0 cursor-pointer'>
                {isAlbumLoading ? (
                  <DisabledButton />
                ) : (
                  <motion.button
  ...
  return <label>
    <div className='flex flex-col items-center justify-center h-full cursor-pointer'>
      <div className='flex flex-col justify-center items-center text-quaternaryColor'>
        ...
        <p className='text-lg text-center'>Presiona para cargar un{isImage ? "a imagen" : " audio"}</p>
      </div>
    </div>
    <input
      type="file"
